...
The recommended way to use this `CrendetialsRequest` is to submit it to `ccoctl` as described in [the post installation instructions](https://github.com/openshift/aws-load-balancer-operator/blob/main/docs/install.md#option-1-using-ccoctl).
