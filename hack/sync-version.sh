...
#   - Containerfile.aws-load-balancer-operator-bundle
...
containerfiles=(
    "${repo_root}/Containerfile.aws-load-balancer-operator-bundle"
    "${repo_root}/Containerfile.aws-load-balancer-operator"
)
