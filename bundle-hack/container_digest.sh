...
# Operator
export OPERATOR_IMAGE_PULLSPEC='quay.io/redhat-user-workloads/aws-load-balancer-operator-tenant/aws-lb-optr-1-3-rhel-9/aws-load-balancer-operator-container-aws-lb-optr-1-3-rhel-9@sha256:22fd46041ba42c276bb2843d4b1fca07d5152bf45fef077e47dd1ffb7f9360a1'
# Controller
